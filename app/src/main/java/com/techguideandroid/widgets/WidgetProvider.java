...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public static final String KEY_ITEM = "com.techguideandroid.widgets.KEY_ITEM";
    public static final String TOAST_ACTION = "com.techguideandroid.widgets.TOAST_ACTION";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction().equals(TOAST_ACTION)){
            ...
            Toast.makeText(context, listItem,Toast.LENGTH_LONG).show();
            onUpdate(context,AppWidgetManager.getInstance(context),null);//intent.setAction...
        }
